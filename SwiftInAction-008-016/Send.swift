...
class SendViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    var add_icon = UIImage(named: "gouxuan_icon.png")
        ...
        super.viewDidLoad()
            ...
            let backBtn = UIBarButtonItem(title: "图库", style: UIBarButtonItemStyle.Plain, target: self, action: "fun_返回图库")
            self.navigationItem.leftBarButtonItem = backBtn
            
            let cancle = UIBarButtonItem(title: "发送", style: UIBarButtonItemStyle.Plain, target: self, action: "send")
